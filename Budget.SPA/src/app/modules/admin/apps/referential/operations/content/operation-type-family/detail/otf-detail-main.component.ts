...
@Component({
    selector       : 'otf-detail-main',
    templateUrl    : './otf-detail-main.component.html',
    encapsulation  : ViewEncapsulation.None,
    animations : fuseAnimations
})
export class OtfDetailMainComponent extends GenericFormComponent implements OnInit, OnDestroy
{
    property: OtfForDetail = null;
    ...
    ngOnDestroy(): void
    {
        this._otfDetailService.destroyForm();
    }
